        ...
        <div class="widgets">
            <div class="widget">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="sTable">
                    ...
                    <tbody>
                    <c:forEach items="${sessionScope.eplist} " var="pay" >
                        <tr>
                            <td align="center">${pay.payid}</td>
                            <td align="center">${pay.pay}</td>
                            <td align="center">${pay.upMoney}</td>
                            <td align="center">${pay.downMoney}</td>
                            <td align="center"><fmt:formatDate value="${pay.payDate}" pattern="yyyy-MM-dd"/></td>
                        </tr>
                    </c:forEach>
